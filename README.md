...
1.7.9
Изменён нодовый генератор Orca.
* Добавлена возможность расчёта спинового заряда

1.7.8
* В AutoDock Vina Creator добавил возможность выбирать лиганд в pdbqt формате. В этом случае преобразования с помощью OpenBabel не происходит, а файл просто копируется в выходную директорию.

1.7.7
* Изменение в AutoDockCreator. Добавлен формат лиганда CDXML.

1.7.6
* Для диаграмм энергий исправлен баг, при котором не открывалось основное окно.

1.7.5
* Для AutoDock Vina: 
  + Изменено имя генерируемого файла Result.csv на Result {Название проекта}.csv. Это связано с тем, что Excel не умеет открывать два файла из разных папок с одинаковым названием.
  + Убрана ненужная асинхронность.
  + Размещение окон по центру экрана.
  + Мелкие правки.
* Для окна «О программе» добавлена информация о генерации AutoDock Vina проектов.
